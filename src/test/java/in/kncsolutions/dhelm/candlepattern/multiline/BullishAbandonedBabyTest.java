...
/**
 * Unit test for BullishAbandonedBaby.class.
 */
public class BullishAbandonedBabyTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishAbandonedBaby  l=new BullishAbandonedBaby(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBullishAbandonedBaby();
			   System.out.println("The pattern is BullishAbandonedBaby : "+ isL);
			}
