...
/**
 * Unit test for BullishSidebySideWhiteLines.class.
 */
public class BullishSidebySideWhiteLinesTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishSidebySideWhiteLines  l=new BullishSidebySideWhiteLines(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBullishSidebySideWhiteLines();
			   System.out.println("The pattern is BullishSidebySideWhiteLines : "+ isL);
			}
