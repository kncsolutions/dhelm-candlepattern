...
/**
 * Unit test for EveningStar.class.
 */
public class EveningStarTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   EveningStar  l=new EveningStar(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isEveningStar();
			   System.out.println("The pattern is EveningStar : "+ isL);
			}
