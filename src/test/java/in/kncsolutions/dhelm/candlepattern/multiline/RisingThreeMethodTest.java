...
/**
 * Unit test for RisingThreeMethod.class.
 */
public class RisingThreeMethodTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   RisingThreeMethod  l=new RisingThreeMethod(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isRisingThreeMethod();
			   System.out.println("The pattern is RisingThreeMethod : "+ isL);
			}
