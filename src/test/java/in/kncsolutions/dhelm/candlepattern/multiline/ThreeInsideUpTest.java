...
/**
 * Unit test for ThreeInsideUp.class.
 */
public class ThreeInsideUpTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   ThreeInsideUp  l=new ThreeInsideUp(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isThreeInsideUp();
			   System.out.println("The pattern is ThreeInsideUp : "+ isL);
			}
