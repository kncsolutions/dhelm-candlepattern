...
/**
 * Unit test for DownsideTasukiGap.class.
 */
public class DownsideTasukiGapTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   DownsideTasukiGap  l=new DownsideTasukiGap(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isDownsideTasukiGap();
			   System.out.println("The pattern is DownsideTasukiGap : "+ isL);
			}
