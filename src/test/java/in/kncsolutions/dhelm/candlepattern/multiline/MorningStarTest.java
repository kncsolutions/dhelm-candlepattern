...
/**
 * Unit test for MorningStar.class.
 */
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   MorningStar  l=new MorningStar(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isMorningStar();
			   System.out.println("The pattern is MorningStar : "+ isL);
			}
