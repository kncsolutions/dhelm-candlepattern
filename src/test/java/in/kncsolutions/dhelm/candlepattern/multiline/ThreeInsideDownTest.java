...
/**
 * Unit test for ThreeInsideDown.class.
 */
public class ThreeInsideDownTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   ThreeInsideDown  l=new ThreeInsideDown(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isThreeInsideDown();
			   System.out.println("The pattern is ThreeInsideDown : "+ isL);
			}
