...
/**
 * Unit test for ThreeWhiteSoldiers.class.
 */
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   ThreeWhiteSoldiers  l=new ThreeWhiteSoldiers(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isThreeWhiteSoldiers();
			   System.out.println("The pattern is ThreeWhiteSoldiers : "+ isL);
			}
