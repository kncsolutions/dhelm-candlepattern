...
/**
 * Unit test for EveningDojiStar.class.
 */
public class EveningDojiStarTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   EveningDojiStar  l=new EveningDojiStar(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isEveningDojiStar();
			   System.out.println("The pattern is EveningDojiStar : "+ isL);
			}
