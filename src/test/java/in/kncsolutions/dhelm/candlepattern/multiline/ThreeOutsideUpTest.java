...
/**
 * Unit test for ThreeOutsideUp.class.
 */
public class ThreeOutsideUpTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   ThreeOutsideUp  l=new ThreeOutsideUp(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isThreeOutsideUp();
			   System.out.println("The pattern is ThreeOutsideUp : "+ isL);
			}
