...
/**
 * Unit test for ThreeBlackCrows.class.
 */
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   ThreeBlackCrows  l=new ThreeBlackCrows(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isThreeBlackCrows();
			   System.out.println("The pattern is ThreeBlackCrows : "+ isL);
			}
