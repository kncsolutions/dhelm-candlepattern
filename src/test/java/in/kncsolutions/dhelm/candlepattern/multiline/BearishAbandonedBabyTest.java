...
/**
 * Unit test for BearishAbandonedBaby.class.
 */
public class BearishAbandonedBabyTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishAbandonedBaby  l=new BearishAbandonedBaby(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBearishAbandonedBaby();
			   System.out.println("The pattern is BearishAbandonedBaby : "+ isL);
			}
