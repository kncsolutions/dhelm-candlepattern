...
/**
 * Unit test for BearishSidebySideWhiteLines.class.
 */
public class BearishSidebySideWhiteLinesTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishSidebySideWhiteLines  l=new BearishSidebySideWhiteLines(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBearishSidebySideWhiteLines();
			   System.out.println("The pattern is BearishSidebySideWhiteLines : "+ isL);
			}
