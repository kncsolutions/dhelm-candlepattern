...
/**
 * Unit test for MorningDojiStar.class.
 */
public class MorningDojiStarTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   MorningDojiStar  l=new MorningDojiStar(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isMorningDojiStar();
			   System.out.println("The pattern is MorningDojiStar : "+ isL);
			}
