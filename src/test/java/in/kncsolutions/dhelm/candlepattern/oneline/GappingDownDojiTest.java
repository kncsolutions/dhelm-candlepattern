...
/**
 * Unit test for GappingDownDoji.class.
 */
public class GappingDownDojiTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   GappingDownDoji  l=new GappingDownDoji(open,high,low,close,25);
			   boolean isL=l.isGappingDownDoji();
			   System.out.println("The pattern is GappingDownDoji : "+ isL);
			}
