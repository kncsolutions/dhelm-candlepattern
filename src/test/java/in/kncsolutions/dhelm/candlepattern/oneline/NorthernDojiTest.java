...
/**
 * Unit test for NorthernDoji.class.
 */
public class NorthernDojiTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   NorthernDoji  l=new NorthernDoji(open,high,low,close,25);
			   boolean isL=l.isNorthernDoji();
			   System.out.println("The pattern is NorthernDoji : "+ isL);
			}
