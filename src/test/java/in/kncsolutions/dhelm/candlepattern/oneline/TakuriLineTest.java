...
/**
 * Unit test for TakuriLine.class.
 */
public class TakuriLineTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   TakuriLine  l=new TakuriLine(open,high,low,close,25,25,70+i);
			   boolean isL=l.isTakuriLine();
			   System.out.println("The pattern is TakuriLine : "+ isL);
			}
