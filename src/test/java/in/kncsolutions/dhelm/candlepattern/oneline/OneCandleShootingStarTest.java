...
/**
 * Unit test for OneCandleShootingStar.class.
 */
public class OneCandleShootingStarTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   OneCandleShootingStar  l=new OneCandleShootingStar(open,high,low,close,25,25,70+i);
			   boolean isL=l.isOneCandleShootingStar();
			   System.out.println("The pattern is OneCandleShootingStar : "+ isL);
			}
