...
/**
 * Unit test for BearishBeltHold.class.
 */
public class BearishBeltHoldTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishBeltHold  l=new BearishBeltHold(open,high,low,close,25,25,70+i,25);
			   boolean isL=l.isBearishBeltHold();
			   System.out.println("The pattern is Bearish Belthold : "+ isL);
			}
