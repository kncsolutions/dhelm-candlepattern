...
/**
 * Unit test for BearishStrongLine.class.
 */
public class BearishStrongLineTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishStrongLine  l=new BearishStrongLine(open,high,low,close,5,25,70+i);
			   boolean isL=l.isBearishStrongLine();
			   System.out.println("The pattern is Bearish Strong Line : "+ isL);
			}
