...
/**
 * Unit test for GappingUpDoji.class.
 */
public class GappingUpDojiTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   GappingUpDoji  l=new GappingUpDoji(open,high,low,close,25);
			   boolean isL=l.isGappingUpDoji();
			   System.out.println("The pattern is GappingUpDoji : "+ isL);
			}
