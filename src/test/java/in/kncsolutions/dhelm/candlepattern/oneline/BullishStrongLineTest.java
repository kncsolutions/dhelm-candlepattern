...
/**
 * Unit test for BullishStrongLine.class.
 */
public class BullishStrongLineTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishStrongLine  l=new BullishStrongLine(open,high,low,close,5,25,70+i);
			   boolean isL=l.isBullishStrongLine();
			   System.out.println("The pattern is Bullish Strong Line : "+ isL);
			}
