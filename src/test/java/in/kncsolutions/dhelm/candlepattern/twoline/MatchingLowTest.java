...
/**
 * Unit test for MatchingLow.class.
 */
public class MatchingLowTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   MatchingLow  l=new MatchingLow(open,high,low,close,25,25,70+i);
			   boolean isL=l.isMatchingLow();
			   System.out.println("The pattern is MatchingLow : "+ isL);
			}
