...
/**
 * Unit test for BullishHarami.class.
 */
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishHarami  l=new BullishHarami(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBullishHarami();
			   System.out.println("The pattern is BullishHarami : "+ isL);
			}
