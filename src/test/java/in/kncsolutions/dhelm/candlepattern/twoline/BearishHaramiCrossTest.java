...
/**
 * Unit test for BearishHaramiCross.class.
 */
public class BearishHaramiCrossTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishHaramiCross  l=new BearishHaramiCross(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBearishHaramiCross();
			   System.out.println("The pattern is BearishHaramiCross : "+ isL);
			}
