...
/**
 * Unit test for BullishDojiStar.class.
 */
public class BullishDojiStarTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishDojiStar  l=new BullishDojiStar(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBullishDojiStar();
			   System.out.println("The pattern is BullishDojiStar : "+ isL);
			}
