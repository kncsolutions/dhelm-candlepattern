...
/**
 * Unit test for MatchingHigh.class.
 */
public class MatchingHighTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   MatchingHigh  l=new MatchingHigh(open,high,low,close,25,25,70+i);
			   boolean isL=l.isMatchingHigh();
			   System.out.println("The pattern is MatchingHigh : "+ isL);
			}
