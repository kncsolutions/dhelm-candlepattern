...
/**
 * Unit test for BearishDojiStar.class.
 */
public class BearishDojiStarTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishDojiStar  l=new BearishDojiStar(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBearishDojiStar();
			   System.out.println("The pattern is BearishDojiStar : "+ isL);
			}
