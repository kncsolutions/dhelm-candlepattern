...
/**
 * Unit test for BullishEngulfing.class.
 */
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishEngulfing  l=new BullishEngulfing(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBullishEngulfing();
			   System.out.println("The pattern is BullishEngulfing : "+ isL);
			}
