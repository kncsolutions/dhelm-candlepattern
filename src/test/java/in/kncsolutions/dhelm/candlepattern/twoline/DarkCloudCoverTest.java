...
/**
 * Unit test for DarkCloudCover.class.
 */
public class DarkCloudCoverTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   DarkCloudCover  l=new DarkCloudCover(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isDarkCloudCover();
			   System.out.println("The pattern is DarkCloudCover : "+ isL);
			}
