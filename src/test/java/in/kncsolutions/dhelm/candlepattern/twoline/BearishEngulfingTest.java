...
/**
 * Unit test for BearishEngulfing.class.
 */
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BearishEngulfing  l=new BearishEngulfing(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBearishEngulfing();
			   System.out.println("The pattern is BearishEngulfing : "+ isL);
			}
