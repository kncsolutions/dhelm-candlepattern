...
/**
 * Unit test for DescendingHawk.class.
 */
public class DescendingHawkTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   DescendingHawk  l=new DescendingHawk(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isDescendingHawk();
			   System.out.println("The pattern is DescendingHawk : "+ isL);
			}
