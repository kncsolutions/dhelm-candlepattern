...
/**
 * Unit test for HomingPigeon.class.
 */
public class HomingPigeonTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   HomingPigeon  l=new HomingPigeon(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isHomingPigeon();
			   System.out.println("The pattern is HomingPigeon : "+ isL);
			}
