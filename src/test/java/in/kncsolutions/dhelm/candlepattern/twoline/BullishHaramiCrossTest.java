...
/**
 * Unit test for BullishHaramiCross.class.
 */
public class BullishHaramiCrossTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BullishHaramiCross  l=new BullishHaramiCross(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isBullishHaramiCross();
			   System.out.println("The pattern is BullishHaramiCross : "+ isL);
			}
