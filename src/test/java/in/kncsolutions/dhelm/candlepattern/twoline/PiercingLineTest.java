...
/**
 * Unit test for PiercingLine.class.
 */
public class PiercingLineTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   PiercingLine  l=new PiercingLine(open,high,low,close,5,25,25,70+i);
			   boolean isL=l.isPiercingLine();
			   System.out.println("The pattern is PiercingLine : "+ isL);
			}
