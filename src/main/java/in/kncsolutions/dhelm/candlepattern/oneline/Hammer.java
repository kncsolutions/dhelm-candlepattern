 ...
 */
 ...
 /**
 *According to literature the hammer pattern is a single line pattern composed of
 ...
 * longer than the body. The candle appears as a long candle. The prior trend should be down trend.
 */
 public class Hammer{
  ...
  */
   public Hammer(List<Double> open,List<Double> high,List<Double> low,List<Double> close,int numLen,int numTrend,double percentage)throws DataException{
    Open.addAll(open);
	 High.addAll(high);
	 Low.addAll(low);
	 Close.addAll(close);
   ...
   *
   */
   private void Hammer()throws DataException{
   ...
   /**
   *@return Returns true if the hammer pattern is generated. 
   */
