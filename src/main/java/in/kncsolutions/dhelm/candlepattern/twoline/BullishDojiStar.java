...
/**
*According to literature the bullish doji star pattern is a two line pattern composed of a
*long candle with black body followed by a doji candle with atleast one shadows, where the body of doji candle is below the body of the previous black candle.
*/
...
private boolean isBullishDojiStar;
/**
...
*/
public BullishDojiStar(List<Double> open,List<Double> high,List<Double> low,List<Double> close,int numBody,int numLen,int numTrend,double percentage)throws DataException{
  Open.addAll(open);
  High.addAll(high);
  Low.addAll(low);
  Close.addAll(close);
...
*
*/
private void BullishDojiStar()throws DataException{
...
*/
public boolean isBullishDojiStar(){
  return isBullishDojiStar;
}
}