...
/**
*According to literature the bullish engulfing pattern is a two line pattern composed of a a black candle
*followed by long candle with white body, where the body of the previous black candle is fully engulfed 
*by the body of the following white candle. The prior trend should be down trend.
*/
...
*/
public BullishEngulfing(List<Double> open,List<Double> high,List<Double> low,List<Double> close,int numBody,int numLen,int numTrend,double percentage)throws DataException{
  Open.addAll(open);
  High.addAll(high);
  Low.addAll(low);
  Close.addAll(close);
...
*
*/
private void BullishEngulfing()throws DataException{  
