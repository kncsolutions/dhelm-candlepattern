...
/**
*According to literature the bearish harami pattern is a two line pattern composed of a
*long candle with white body followed by a black candle, where the body of the black candle is fully engulfed 
*by the body of the previous white candle. The prior trend should be up trend.
*/
