...
/**
*According to literature the bearish abandoned baby  pattern is a three line pattern composed of a
*long candle with white body followed by a doji candle with at least one shadow, followed by a long black candle, where the low of the  doji candle is abovw the high of the
*previous white candle and the following black candle's high is lower than the low of the doji candle. The prior trend should be up trend.
*/
public class BearishAbandonedBaby{
...
private boolean isBearishAbandonedBaby;
/**
...
*/
public BearishAbandonedBaby(List<Double> open,List<Double> high,List<Double> low,List<Double> close,int numBody,int numLen,int numTrend,double percentage)throws DataException{
  Open.addAll(open);
  High.addAll(high);
  Low.addAll(low);
  Close.addAll(close);
...
*
*/
private void BearishAbandonedBaby()throws DataException{
...
/**
*@return Returns true if the bearish abandoned baby pattern is generated. 
*/
public boolean isBearishAbandonedBaby(){
  return isBearishAbandonedBaby;
}
}