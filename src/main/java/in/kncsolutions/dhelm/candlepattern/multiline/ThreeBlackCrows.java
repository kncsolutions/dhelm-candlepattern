...
/**
*According to literature the three black crows  pattern is a three line pattern composed of three consecutive
*long candle with black bodies, where the closing  of each candle is lesser than the closing of previous candle and
*opening of each candle is within the body of the prior candle. Prior trend should be up trend.
*/
...
*/
public ThreeBlackCrows(List<Double> open,List<Double> high,List<Double> low,List<Double> close,int numBody,int numLen,int numTrend,double percentage)throws DataException{
  Open.addAll(open);
  High.addAll(high);
  Low.addAll(low);
  Close.addAll(close);
...
*
*/
private void ThreeBlackCrows()throws DataException{
...
/**
*@return Returns true if the three black crows pattern is generated. 
*/
