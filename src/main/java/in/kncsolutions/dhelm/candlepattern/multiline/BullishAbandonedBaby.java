...
/**
*According to literature the bullish abandoned baby  pattern is a three line pattern composed of a
*long candle with black body followed by a doji candle with at least one shadow, followed by a long white candle, where the high of the  doji candle is below the low of the
*previous black candle and the following white candle's low is greater than the high of the doji candle. The prior trend should be down trend.
*/
public class BullishAbandonedBaby{
...
private boolean isBullishAbandonedBaby;
/**
...
*/
public BullishAbandonedBaby(List<Double> open,List<Double> high,List<Double> low,List<Double> close,int numBody,int numLen,int numTrend,double percentage)throws DataException{
  Open.addAll(open);
  High.addAll(high);
  Low.addAll(low);
  Close.addAll(close);
...
*
*/
private void BullishAbandonedBaby()throws DataException{
...
/**
*@return Returns true if the bullish abandoned baby pattern is generated. 
*/
public boolean isBullishAbandonedBaby(){
  return isBullishAbandonedBaby;
}
}